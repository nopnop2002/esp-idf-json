...
void app_main()
{
	...
	cJSON_AddItemToArray(array, element[0]);
	element[1] = cJSON_CreateNumber(123);
	cJSON_AddItemToArray(array, element[1]);
	element[2] = cJSON_CreateTrue();
	cJSON_AddItemToArray(array, element[2]);
	element[3] = cJSON_CreateFalse();
	cJSON_AddItemToArray(array, element[3]);
	element[4] = cJSON_CreateNull();
	cJSON_AddItemToArray(array, element[4]);
